...
# use the four lines below for use on Patas
...
# use the three lines below for debugging locally
...
#     df = pd.concat(
#         [
#             dfn.rename(columns={"noteText": typeText}),
#             dft.rename(columns={"tweetText": typeText}),
#         ],
#         axis=0,
#         ignore_index=True,
#     )
...
def mainGeneration(df, typeText):
    # chunking
